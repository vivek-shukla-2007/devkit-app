...
export default function NumberBaseConverterPage() {
    ...
    return (
        <main className="flex-grow container mx-auto px-4 py-8">
            <h2 className="text-3xl font-bold text-center text-gray-800 dark:text-white mb-8">Number Base Converter</h2>
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8 border border-gray-200 dark:border-gray-700 max-w-2xl mx-auto">
                <div className="mb-4">
                    <label htmlFor="input-value" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Input Value</label>
                    <input type="text" id="input-value" value={inputValue} onChange={(e) => setInputValue(e.target.value.toLowerCase())} placeholder={`e.g. ${bases.find(b => b.value === fromBase)?.example || '101'}`} className="w-full p-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-blue-500 focus:border-blue-500 font-mono" />
                </div>
                ...
                <div className="flex justify-center mb-6">
                    <button onClick={handleConvert} className="px-8 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700">Convert</button>
                </div>
                ...
                {outputValue && !error && (
                    <div className="mb-4">
                        ...
                        <div className="flex rounded-md shadow-sm">
                            <input type="text" id="output-value" value={outputValue} readOnly className="flex-1 block w-full min-w-0 rounded-none rounded-l-md p-2.5 border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 font-mono focus:ring-blue-500 focus:border-blue-500" />
                            <button onClick={handleCopyToClipboard} className="inline-flex items-center px-3 rounded-r-md border border-l-0 border-gray-300 dark:border-gray-600 bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600">
